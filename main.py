...
def data_gen(path, load, sample_size):
    ...
    train_set_idx = train_data_gen(path = path, word2idx = word2idx, max_distance= sample_size, load = False, batch = 50000, save = False)
...
def main():
    ...
    model = skip_gram(vocab_size= vocab_size, projection_layer= embed_size, sample_size = C)
